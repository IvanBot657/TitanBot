  ...
  try {
    ...
    sock.ev.on("connection.update", async update => {
      try {
        ...
        if (qr && !state.creds.registered) {
          ...
          if ((PAIRING_METHOD === "number" || PAIRING_METHOD === "both") && PAIRING_NUMBER && !pairingCodeRequested) {
    ...
    if (!state.creds.registered) {
      ...
      if (PAIRING_METHOD === "number" || PAIRING_METHOD === "both") {
        console.log("🔢 Se intentará generar código por número cuando llegue el QR.");
      }
      if (PAIRING_METHOD === "qr" || PAIRING_METHOD === "both") {
