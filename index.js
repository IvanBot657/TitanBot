...
⚡ Sistema: Funcionando`
    ...
    // 🔠 MAYÚSCULAS
    else if (comando.startsWith(".mayus ")) {
    ...
    // 🔡 MINÚSCULAS
    else if (comando.startsWith(".minus ")) {
    ...
    // 🔢 CONTADOR
    else if (comando.startsWith(".contador ")) {
...
${contenido}`
    ...
    // 🧮 CALCULADORA
    else if (comando.startsWith(".calcular ")) {
      ...
      if (!/^[0-9+\-*/().\s]+$/.test(operacion)) {
        ...
        await sock.sendMessage(msg.key.remoteJid, {
          text: "❌ Solo puedes usar números y operadores + - * /"
        });
      ...
      try {
        ...
        const resultado =
          Function(`"use strict"; return (${operacion})`)();
